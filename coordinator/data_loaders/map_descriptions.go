...
func (loader *DescriptionsLoader) Init(offset string) {
	loader.offset, _ = strconv.Atoi(offset)
}

func (loader *DescriptionsLoader) GetOffset() string {
	return strconv.Itoa(loader.offset)
}
